...
![image-20220226181011416](E:\桌面\毕业设计\shiro实战教程资料\Shiro 实战教程.assets\image-20220226181011416.png)
...
public class CustomerRealm extends AuthorizingRealm {
    ...
    @Override
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        String principal = (String) token.getPrincipal();//h
        if("xiaochen".equals(principal)){
            String password = "3c88b338102c1a343bcb88cd3878758e";//从数据库中获取
            String salt = "Q4F%";//从数据库中获取，每个用户的salt值不同
